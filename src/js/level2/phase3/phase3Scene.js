...
const box2 = new THREE.Mesh(boxGeometry1,boxMaterial)
const box3 = new THREE.Mesh(boxGeometry,boxMaterial)
const box4 = new THREE.Mesh(boxGeometry1,boxMaterial)
...
box1.position.set(gridMapHelper.getGlobalXPositionFromCoord(1),1.0,gridMapHelper.getGlobalZPositionFromCoord(2))
box2.position.set(gridMapHelper.getGlobalXPositionFromCoord(2),1.0,gridMapHelper.getGlobalZPositionFromCoord(1))
box3.position.set(gridMapHelper.getGlobalXPositionFromCoord(8),1.0,gridMapHelper.getGlobalZPositionFromCoord(7))
box4.position.set(gridMapHelper.getGlobalXPositionFromCoord(7),1.0,gridMapHelper.getGlobalZPositionFromCoord(8))

fireHole.position.set(gridMapHelper.getGlobalXPositionFromCoord(2),0.5,gridMapHelper.getGlobalZPositionFromCoord(0))
