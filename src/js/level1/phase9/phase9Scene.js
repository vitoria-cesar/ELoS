...
box.position.set(gridMapHelper.getGlobalXPositionFromCoord(6),1.0,gridMapHelper.getGlobalZPositionFromCoord(7))
...
advanceBtn.addEventListener('click',function(e){
    ...
    if(!storedLevelValue)
    {
        setTimeForNextPhase('/level1/phase10/',getTotalTime(sceneProperties.phaseTimer.getElapsedTime(), true))
